...
func StaffSearchTool() *mcp.Tool {
	return &mcp.Tool{
		Name:        "staff_search",
		Description: `企业/教育机构信息查询工具。凡是用户问题涉及员工、教师、校区、学院、部门、学科、课程、专业或它们之间的关系查询，必须优先调用本工具。工具会返回可用于回答的 context 和 sources。模型必须基于返回的 context 与 sources 作答，不得直接猜测；若存在重名、歧义或信息不足，需先澄清或明确说明未查到。`,
